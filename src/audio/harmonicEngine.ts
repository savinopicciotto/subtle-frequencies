...
export const HARMONIC_SERIES = [
  ...
  { ratio: 1.614, label: 'Solfeggio FA/UT (639/396)' },
  { ratio: 1.618, label: 'φ (Golden Ratio)' },
  { ratio: 1.732, label: '√3 (Sacred Triangle)' },
  { ratio: 1.871, label: 'Solfeggio SOL/UT (741/396)' },
  { ratio: 2, label: '2nd Harmonic (Octave)' },
  { ratio: 2.152, label: 'Solfeggio LA/UT (852/396)' },
  { ratio: 2.236, label: '√5 (Pentagonal Harmony)' },
  { ratio: 2.432, label: 'Solfeggio TI/UT (963/396)' },
  { ratio: 2.618, label: 'φ² (Golden Ratio Squared)' },
  { ratio: 2.828, label: '2√2 (Double Tritone)' },
  { ratio: 3, label: '3rd Harmonic (Perfect 5th + Octave)' },
  { ratio: 3.464, label: '2√3 (Double Triangle)' },
  { ratio: 4, label: '4th Harmonic (2 Octaves)' },
  { ratio: 4.236, label: 'φ³ (Golden Ratio Cubed)' },
  { ratio: 5, label: '5th Harmonic (Major 3rd + 2 Octaves)' },
  { ratio: 6, label: '6th Harmonic' },
  { ratio: 6.854, label: 'φ⁴ (Golden Ratio ^4)' },
